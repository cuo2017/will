...
var TITLE = 'Welcome';
var SLOGAN = '- will x C.U.O -';

// Components

var board = function (_React$Components) {
	_inherits(board, _React$Components);
...
var will = function (_React$Components2) {
	_inherits(will, _React$Components2);

	function will() {
		_classCallCheck(this, will);

		return _possibleConstructorReturn(this, (will.__proto__ || Object.getPrototypeOf(will)).apply(this, arguments));
	}
...
_reactDom2.default.render(_react2.default.createElement("will", null), document.getElementById('app'));
